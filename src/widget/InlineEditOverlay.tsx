      ...
      >
        {collapsed ? (
          <svg
            ...
            aria-hidden="true"
          >
            <rect x="4" y="4" width="16" height="1.5" />
            <rect x="4" y="11.25" width="16" height="1.5" />
            <rect x="4" y="18.5" width="16" height="1.5" />
            <rect x="4" y="4" width="1.5" height="16" />
            <rect x="11.25" y="4" width="1.5" height="16" />
            <rect x="18.5" y="4" width="1.5" height="16" />
          </svg>
        ) : (
          <svg
            width="14"
